...
**Update (2026-09-06 re-check):** still fixed, no regression. `main`
unchanged since 08-01. (The minor staleness noted last week — `MEMORY.md`
not mentioning music-analyzer/palette work merged since 07-18 — is
unchanged too; still not worth a separate finding.)
