...
That is the product question. The [live dashboard](/ember) shows current fire activity and conditions for Shasta County, CA, scored and briefed automatically on a daily cadence.
...
<StackList items={[
  ...
  { name: "NASA FIRMS", role: "NRT VIIRS and MODIS fire detection feeds for the Shasta County bounding box", frequency: "daily" },
